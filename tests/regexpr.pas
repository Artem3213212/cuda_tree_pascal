...
{$ENDIF}
 ...
 TRegExpr = class
   ...
   public
    ...
    // If true, then Р°-СЏ  additional include russian letter 'С‘',
    // Рђ-РЇ  additional include 'РЃ', and Р°-РЇ include all russian symbols.
...
//  i : int64;
 begin
  ...
  if val < scan
   ...
   // "P вЂ“ Q computes the difference between the address given
...
{$IFDEF UniCode}
 ...
 RusRangeLoLow = #$430{'Р°'};
 RusRangeLoHigh = #$44F{'СЏ'};
 RusRangeHiLow = #$410{'Рђ'};
 RusRangeHiHigh = #$42F{'РЇ'};
{$ELSE}
 RusRangeLo = 'Р°Р±РІРіРґРµС‘Р¶Р·РёР№РєР»РјРЅРѕРїСЂСЃС‚СѓС„С…С†С‡С€С‰СЉС‹СЊСЌСЋСЏ';
 RusRangeHi = 'РђР‘Р’Р“Р”Р•РЃР–Р—РР™РљР›РњРќРћРџР РЎРўРЈР¤РҐР¦Р§РЁР©РЄР«Р¬Р­Р®РЇ';
 RusRangeLoLow = 'Р°';
 RusRangeLoHigh = 'СЏ';
 RusRangeHiLow = 'Рђ';
 RusRangeHiHigh = 'РЇ';
...
procedure TRegExpr.SetInputString (const AInputString : RegExprString);
 ...
 begin
  ...
  !! startp/endp РІСЃРµ СЂР°РІРЅРѕ Р±СѓРґРµС‚ РѕРїР°СЃРЅРѕ РёСЃРїРѕР»СЊР·РѕРІР°С‚СЊ ?
  }
